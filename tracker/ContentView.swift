...
#Preview {
    ...
    testStore.chains = [
        ChainModel(
            ...
            events: [
                ChainEventModel(id: UUID(), name: "Разминка", duration_work: 5, pauseAfter: 3),
                ChainEventModel(id: UUID(), name: "Бег", duration_work: 5, pauseAfter: 3),
                ChainEventModel(id: UUID(), name: "Растяжка", duration_work: 5, pauseAfter: 2)
            ]
        )
    ]
